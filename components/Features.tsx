...
function Features() {
  ...
  const heightFix = () => {
    if (tabs && tabs!.current !== null && tabs!.current!['children'][tab]) {
              ...
              <div className="relative flex flex-col text-center lg:text-right">
                ...
                >
                  <div className="relative inline-flex flex-col">
                    ...
                    <Image className="md:max-w-none absolute w-full left-0 transform animate-float top-1/3" src='/images/features-element.png' width="500" height="44" alt="Element" />
                  </div>
                </Transition>
                {/* Item 2 */}
                <Transition
